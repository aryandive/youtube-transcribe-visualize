...
export function ConversionModal({ open, onOpenChange, triggerType }: ConversionModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md backdrop-blur-xl bg-background/90 border-white/10 shadow-2xl">
                <DialogHeader>
                ...
                <div className="flex flex-col gap-3 mt-6">
                    <Button variant="outline" className="w-full h-12 text-md flex items-center justify-center gap-3">
                ...
                <Button variant="secondary" className="w-full h-12 text-md flex items-center justify-center gap-3">
